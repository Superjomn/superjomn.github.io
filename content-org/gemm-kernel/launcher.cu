...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  //m.def("gemm_tiled_mma_64x64x16_f16", &gemm_tiled_mma_f16<64, 64, 16>, "GEMM Tiled MMA");
  m.def("gemm_tiled_mma_128x128x64_f16", &gemm_tiled_mma_f16<128, 128, 64>, "GEMM Tiled MMA");
  //m.def("gemm_tiled_mma_256x256x16_f16", &gemm_tiled_mma_f16<256, 256, 16>, "GEMM Tiled MMA");
}
